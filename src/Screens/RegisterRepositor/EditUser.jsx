...
export default function EditUser() {
    ...
    if( numberPhone == null || nameUser == null || password == null || levelAcess == null || idUser == null){
    ...
    function putInfos(){
    const url = `http://localhost:3000/attUser/${nameUser}/${numberPhone}/${password}/${levelAcess}/${idUser}`;
    ...
    <div>
        ...
        <div>
            <div className='Screen-registerUser-level-box'>
                <div className='Screen-registerUser-level'>
                    <p><b>ID do Ususario</b></p>
                    <input type="number" placeholder='Nivel de Acesso' value={idUser} onChange={onchangeIdUser}/>
                </div>
            </div>
        </div> 
